...
class TexturePack(typing.NamedTuple):
    ...
    def load(cls, infile: typing.BinaryIO) -> "TexturePack":
        ...
        return TexturePack(raw.version, [get_texture(raw, i) for i in range(raw.num_textures)])
...
if __name__ == "__main__":
    pack = TexturePack.load(open("C:/Program Files (x86)/Steam/steamapps/common/Crystal Project/Content/Textures/Voxel.dat", "rb"))
    print(pack)
